...
SCHEMA = {
    ...
    "scenario": {
        "win":         dict(d="timed_score", t="enum", opts=["timed_score", "territory", "domination"],
                            doc="Victory condition. timed_score: cargo hauled + kills. territory: control points from holding named territories. domination: no clock — last admiral standing wins."),
